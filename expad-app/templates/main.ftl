<html>
    <head>
        ...
        <link href="/expad/css/bootstrap.min.css" rel="stylesheet">
        <link href="/expad/css/main.css" rel="stylesheet">
        <link href="/expad/favicon.ico" rel="SHORTCUT ICON">
        <link href="/expad/favicon.ico" type=image/ico rel=icon>
        <script language="javascript" src="/expad/scripts/jsrsClient_rev.js"></script>
        <script>
            var obj;
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    ...
                    <div class="account-wall">
                        <img class="profile-img" src="/expad/images/logo.png"
                             alt="">
                        <form class="form-signin" name="login"  action="/expad/services/main" method="post">
