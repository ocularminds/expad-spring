...
<div class="table-responsive" id="table-list">
    <center><h1>Cards For Printing</h1></center>
    <table class="table table-stripped" id="data-table" width="100%">
        ...
        <tbody>
            <#list cards as card>
            <tr>
                <td><a href="/cards/api/approval/" class="btn btn-primary detail-link">${card.getId()}</a></td>
...
<div class="row">
    <div class="col-md-12" align="center">
        <ul class="list-group" id="account-link">
            <li>account.getAccountNumber()</i>
        </ul>
    </div>
</div>
<div class="row">
